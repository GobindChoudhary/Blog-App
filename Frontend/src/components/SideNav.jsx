...
const SideNav = () => {
  ...
  const [showSideNav, setShowSideNav] = useState(true); // ✅ start visible on desktop
  ...
  const changePageState = (e) => {
    ...
    if (e.target === sideBarIconTab.current) {
      setShowSideNav((prev) => !prev); // ✅ toggle on hamburger
    } else {
      setShowSideNav(false); // ✅ auto-close on mobile
  ...
  useEffect(() => {
    ...
    if (pageStateTab.current) {
      pageStateTab.current.click(); // ✅ avoid null crash
    }
  }, [pageState]);
